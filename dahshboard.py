...
st.sidebar.write("**Nama:** Febri Haerani")
st.sidebar.write("**Email:** febrihaerani5@gmail.com")
...
ax.set_title('Rata-rata Pengguna Sepeda dalam Waktu Holiday, Weekday, Workingday')
st.pyplot(fig)

st.subheader("Perbandingan Pengguna Terdaftar (Registered) dan Casual")
